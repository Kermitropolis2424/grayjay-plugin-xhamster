...
**[Install Plugin](grayjay://plugin/https://github.com/Kermitropolis2424/grayjay-plugin-xhamster/releases/latest/download/config.json)**

Or use this URL:

```
grayjay://plugin/https://github.com/Kermitropolis2424/grayjay-plugin-xhamster/releases/latest/download/config.json
```
...
- **Repository**: grayjay://plugin/https://github.com/Kermitropolis2424/grayjay-plugin-xhamster
...
For issues and questions, please use the [GitHub Issues](grayjay://plugin/https://github.com/Kermitropolis2424/grayjay-plugin-xhamster/issues) page.
